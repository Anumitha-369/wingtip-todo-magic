  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        'gradient-radial': 'radial-gradient(circle, hsl(var(--gradient-start)), hsl(var(--gradient-mid)))',
      },
      borderRadius: {
        lg: "var(--radius)",
      ...
      keyframes: {
        ...
        "fly-in": {
          "0%": { transform: "translateX(100vw) translateY(-100px) rotate(-45deg)", opacity: "0" },
          "50%": { opacity: "1" },
